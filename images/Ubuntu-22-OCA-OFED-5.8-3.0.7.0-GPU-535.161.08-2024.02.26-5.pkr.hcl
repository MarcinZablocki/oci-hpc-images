...
variable "image_base_name" {
  type    = string
  default = "Ubuntu-22-OCA-OFED-5.8-3.0.7.0-GPU-535.129.03-2024.02.26-5"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_58_3070", "hpcx_2131", "openmpi_414", "nvidia_535.161.08", "nvidia_cuda_12_2" , "use_plugins" ]
}
