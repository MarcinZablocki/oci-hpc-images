...
variable "image_base_name" {
  type    = string
  default = "Ubuntu-22-OCA-OFED-23.10-2.1.3.1-GPU-550.54.15-CUDA-12.4-2024.02.26-5-2"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_2310_2131", "hpcx_2131", "openmpi_414", "nvidia_550_54_15_ubuntu2204_local", "nvidia_cuda_12_4" , "use_plugins" ]
}
